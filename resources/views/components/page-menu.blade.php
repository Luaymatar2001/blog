...
<head>
    ...
    <!--Color Themes-->
    <link id="{{asset('theme-color-file" href="css/color-themes/default-theme.css')}}" rel="stylesheet">
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header">
                ...
                <div class="inner-container">
                    <div class="auto-container clearfix">
                        ...
                        <div class="logo-outer">
                            <div class="logo" style="width: 150px; height = 70px;"><a href="index.html"><img
                                        src="{{$about->image_url}}" alt="" title=""></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                ...
                                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        {{-- <li class="dropdown"><a href="{{route('home.index')}}">Home</a>
                                        <ul>
                                        ...
                                        <li class="current dropdown"><a href="{{route('home.index')}}">Blog</a>
                                        </li>
            ...
            <section class="page-title" style="background-image:url({{$about->image_url}});">
                <div class="auto-container">
                    <h1>{{$about->name}}</h1>
                    {{-- <div class="text">What We Actually Do?</div> --}}
                    <ul class="bread-crumb clearfix">
                        <li><a href="{{route('home.index')}}"><span class="fas fa-home"></span> Home </a></li>
                        <li>{{ $breadcrumbs1 }}</li>
                    </ul>
                </div>
            </section>
            ...
            <section class="blog-page-section">
                <div class="auto-container">
                    <div class="row clearfix" id="div_news">
                        {{$slot}}
            </section>
    </div>
    </div>
